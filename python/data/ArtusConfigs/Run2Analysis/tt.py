...
def build_config(nickname):
  ...
  if re.search("Run2016(B|C|D|E|F|G)", nickname): 
    ...
    config["HLTBranchNames"] = ["trg_doubletau1:HLT_DoubleMediumIsoPFTau35_Trk1_eta2p1_Reg_v",
                                "trg_doubletau2:HLT_DoubleMediumCombinedIsoPFTau35_Trk1_eta2p1_Reg_v"]
